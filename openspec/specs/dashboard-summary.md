...
The dashboard summary capability provides aggregate statistics and live update indication on the main dashboard, giving users an at-a-glance view of their comment triaging progress across all tracked threads.
